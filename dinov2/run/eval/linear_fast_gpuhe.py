...
from dinov2.eval.linear_fast import get_args_parser as get_linear_args_parser
from dinov2.logging import setup_logging
from dinov2.run.submit_train import get_args_parser, submit_jobs
...
class Evaluator:
    ...
    def __call__(self):
        from dinov2.eval.linear_fast import main as linear_main
